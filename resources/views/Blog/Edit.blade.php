        ...
        <div class="form-card mx-auto" style="max-width: 640px;">
            ...
            <form action="{{ route('Blog.post') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" id="title" placeholder="タイトルを入れてください" class="form-control" required>
                </div>
                <div class="mb-3">
                    <label for="title" class="form-label">タグ</label>
                    <input type="text" name="tag" id="title" placeholder="タグを入れてください" class="form-control" required>
                </div>
